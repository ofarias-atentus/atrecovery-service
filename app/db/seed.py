...
PERMISSION_DEFS: list[tuple[str, str]] = [
    ...
    ("routine:manage", "Create/update/delete routines"),
    ("category:view", "List and read routine categories"),
    ("category:manage", "Create/update/delete routine categories"),
...
RESOURCE_TYPE_DEFS: list[dict] = [
    {
        ...
        "schema": {
            ...
            "properties": {
                ...
                "device_ultima_actualizacion": {"type": "string"},
                "fecha_ultima_replicacion": {"type": "string"},
            },
        },
    },
]
